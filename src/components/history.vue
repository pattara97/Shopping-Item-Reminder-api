        ...
        <b-col class="col-lg-8 col-md-10 col-sm-12">
          <b-card>
            <template v-slot:header>
              <h4 class="mb-0">ประวัติรายการที่ยังไม่เสร็จ</h4>
            </template>
...
export default {
  ...
  mounted() {
    ...
    axios
      .post(api.url + "/getyear/his/false", {
        user: loggedIn.username
      })
      .then(response => {
    ...
    axios
      .post(api.url + "/getmount/his/false", {
        user: loggedIn.username
      })
      .then(response => {
